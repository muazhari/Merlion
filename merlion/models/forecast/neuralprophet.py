...
#
"""
Wrapper around NeuralProphet model for time series forecasting.
"""
import copy
import logging
import os
...
class _suppress_stdout_stderr(object):
    ...
    Source: https://github.com/facebook/neuralprophet/issues/223#issuecomment-326455744
    """
...
class NeuralProphetConfig(ForecasterExogConfig):
    """
    Configuration class for `NeuralProphet` model, as described by
...
class NeuralProphet(ForecasterExogBase, SeasonalityModel):
    """
    Model for time series forecasting. See docs for `NeuralProphetConfig`
    and `Taylor & Letham, 2017 <https://peerj.com/preprints/3190/>`__ for more details.
    """

    config_class = NeuralProphetConfig
    ...
    def _train_with_exog(
        ...
        # sigma computation based on https://github.com/facebook/neuralprophet/issues/549#issuecomment-435482584
    ...
    def _forecast_with_exog(
        ...
        # Construct data frame for neuralprophet
        ...
        # Get MAP estimate from neuralprophet
        self.model.uncertainty_samples = 0
